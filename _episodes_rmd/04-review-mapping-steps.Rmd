...
```{r covariates_sig_function_plots}
tmp %>%
...
```{r QTL_perm_saving, warning=FALSE, error=FALSE, eval=F, echo=F}
save(operm, file="../data/operm_Ins_tAUC_log_1000.Rdata")
...
```{r QTL_perm_file, warning=FALSE, error=FALSE}
